  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#131722' }}>
      <div style={{ background: '#1a1f2e', border: '1px solid #252d3d', borderRadius: '12px', padding: '36px', width: '360px' }}>
        ...
        <div style={{ fontSize: '12px', color: '#8892a4', marginBottom: '28px' }}>Create your account</div>
        ...
        <div style={{ marginBottom: '12px' }}>
          <div style={{ fontSize: '11px', fontWeight: 600, color: '#8892a4', marginBottom: '5px' }}>FULL NAME</div>
        ...
        <p style={{ color: '#8892a4', fontSize: '12px', marginTop: '16px', textAlign: 'center' }}>
          Already have an account? <a href="/login" style={{ color: '#2962FF', textDecoration: 'none' }}>Sign in</a>
        </p>
      </div>
    </div>
  )
